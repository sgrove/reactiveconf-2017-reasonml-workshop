...
var MyBannerRe$HelloReactive = require("./myBannerRe.js");
...
function make(message, extraGreeting, _) {
  ...
  newrecord[/* render */9] = (function () {
      ...
      return React.createElement("div", undefined, ReasonReact.element(/* None */0, /* None */0, MyBannerRe$HelloReactive.make(/* true */1, message + (" " + greeting), /* array */[])));
    });
  return newrecord;
}
